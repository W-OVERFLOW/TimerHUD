package xyz.queffe.timerhud.tweaker;
 ...
 */
public class TimerHUDLoadingPlugin implements IFMLLoadingPlugin {

    public TimerHUDLoadingPlugin() {
    ...
    private void showMessage(File file) {
        ...
        discordLink.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent event) {
                try {
                    Desktop.getDesktop().browse(new URI("https://inv.wtf/queffe"));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        JOptionPane.showOptionDialog(
                frame,
                "<html><p>TimerHUD has detected a mod with an older version of Kotlin.<br>The culprit is " + file.toString() + ".<br>It packages version " + KotlinVersion.CURRENT + ".<br>In order to resolve this conflict you must make TimerHUD be<br>above this mod alphabetically in your mods folder.<br>This tricks Forge into loading TimerHUD first.<br>You can do this by renaming your TimerHUD jar to !TimerHUD.jar,<br>or by renaming the other mod's jar to start with a Z.<br>If you have already done this and are still getting this error,<br>ask for support in the Discord.</p></html>",
                "TimerHUD Error",
