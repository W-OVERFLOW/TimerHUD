...
object APIUtil {
    ...
    val builder: HttpClientBuilder =
        HttpClients.custom().setUserAgent("${TimerHUD.NAME}/${TimerHUD.VERSION}")
    ...
    fun getJSONResponse(urlString: String): JsonObject {
        ...
        try {
            ...
            ex.printStackTrace()
            TimerHUD.sendMessage("§cAn error has occured whilst fetching a resource. See logs for more details.")
        } finally {
            client.close()
        }
        return JsonObject()
